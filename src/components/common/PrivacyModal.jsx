// PrivacyModal.jsx (z-index fixed)
...
const PrivacyModal = ({ isOpen, onClose }) => {
  ...
  return ReactDOM.createPortal(
    <div
      ...
      /* outer container: very high z so it sits above splash (which used 99999) */
      className="fixed inset-0 z-[1000001] flex items-center justify-center px-4"
    >
      {/* backdrop: slightly lower than modal content but still very high */}
      <div
        onClick={onClose}
      ...
      <div
        ref={modalRef}
        tabIndex={-1}
        /* modal content: highest z so it sits above the backdrop */
      ...
      >
        ...
        <div className="mt-4 space-y-4 text-sm leading-relaxed">
          ...
          <p>
            Welcome to NAYASH GROUP. We respect your privacy and are committed to protecting your personal data.
          ...
          <p>
            We use your information to provide and improve services, communicate with you, and comply with legal obligations.
          </p>

          <h3 className="font-semibold mt-2">Third Parties</h3>
          <p>
            We may share information with service providers who perform services on our behalf. We do not sell personal data.
          </p>

          <h3 className="font-semibold mt-2">Your Rights</h3>
          <p>
            Depending on your jurisdiction, you may have rights to access, correct, delete, or restrict processing of your information.
            Contact us for any requests.
          </p>

          <h3 className="font-semibold mt-2">Contact</h3>
          <p>
            For privacy inquiries, email: <a href="mailto:privacy@nayash.example" className="text-indigo-600 hover:underline">nayashdesignstudio@gmail.com</a>
          </p>
