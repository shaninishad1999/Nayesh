...
const CompanyValuesPage = () => {
  return (
    <div className="min-h-screen bg-white">
      {/* Values Section */}
      <div className="bg-red-500 text-white py-16 pb-40 px-8 relative">
  ...
  <div className="text-left relative pb-6 md:pb-0">
    ...
    <p className="text-sm leading-relaxed opacity-90 pr-8 md:pr-0">
      Homes that embrace your everyday rituals, from morning light in the
      kitchen to quiet corners made for unwinding.
    </p>
  </div>
  ...
  <div className="text-left relative pb-6 md:pb-0">
    ...
    <p className="text-sm leading-relaxed opacity-90">
      Clear conversations, honest timelines, and a journey without hidden turns
  ...
  <div className="text-left relative">
    ...
    <p className="text-sm leading-relaxed opacity-90 pr-8 md:pr-0">
      Craftsmanship that lingers in the little things: solid doors that close
      softly, finishes that age with grace, and spaces built to hold generations
      of memories.
    </p>
  </div>
</div>
      ...
      <div className="relative -mt-32 px-8">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
          {/* Listen */}
          <div className="bg-white shadow-xl p-8 flex flex-col items-center text-center min-h-[450px]">
            <div className="flex-1 flex flex-col justify-center">
              <h3 className="text-2xl font-bold text-red-500 mb-8 tracking-wider">
                LISTEN
              </h3>
              <div className="relative w-8 h-32 mx-auto mb-8">
                {/* Vertical line (height bada di) */}
                <div className="absolute left-1/2 top-0 h-full border-l-2 border-red-500 transform -translate-x-1/2"></div>

                {/* Top horizontal line */}
                <div className="absolute top-0 left-1/2 w-8 border-t-2 border-red-500 transform -translate-x-1/2"></div>

                {/* Bottom horizontal line */}
                <div className="absolute bottom-0 left-1/2 w-8 border-t-2 border-red-500 transform -translate-x-1/2"></div>
              </div>
