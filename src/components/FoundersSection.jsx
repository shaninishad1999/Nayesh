...
export default function FoundersSection() {
  ...
  useLayoutEffect(() => {
    ...
    tl.from(
      ...
      { scale: 0.96, opacity: 0, duration: 0.7, transformOrigin: "center center" },
      "-=0.35"
    );
    tl.from(
    ...
    tl.from(
      dividerRefs.current,
      { scaleX: 0, opacity: 0, transformOrigin: "left center", duration: 0.45, stagger: 0.08 },
      "-=0.25"
    );
    ...
    const subtleLoop = gsap.to([firstImageRef.current, secondImageRef.current], {
      scale: 1.01,
      duration: 2.8,
      yoyo: true,
      repeat: -1,
  ...
  return (
    <section ref={sectionRef} className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-10 bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[auto_minmax(0,1fr)] gap-8 sm:gap-12 items-center">
        ...
        <div className="flex flex-col lg:flex-row w-full h-full text-center lg:text-left space-y-6 lg:space-y-0 lg:space-x-10">
          {/* Attribution */}
          <div ref={firstAttrRef} className="flex flex-col justify-end w-full lg:w-auto whitespace-nowrap">
            <img
              src={markImg}
              alt="signature mark"
          ...
          {/* Quote */}
          <blockquote ref={firstQuoteRef} className="font-myriad w-full lg:flex lg:items-center">
            <div className="w-full text-center lg:text-right max-w-2xl mx-auto lg:mx-0">
              <p className="text-sm sm:text-base md:text-lg lg:text-2xl text-gray-700 font-bold leading-relaxed mb-2 sm:mb-1">
                "Every project is personal. For us,
              </p>
      ...
      <div className="mt-7 mb-10">
        <div className="space-y-1">
          <div ref={(el) => setDividerRef(el, 0)} className="h-px bg-[#C16367] w-full" />
          <div ref={(el) => setDividerRef(el, 1)} className="h-px bg-[#C16367] w-full" />
          <div ref={(el) => setDividerRef(el, 2)} className="h-px bg-[#C16367] w-full" />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_auto] gap-10 items-stretch">
        ...
        <div className="flex flex-col w-full text-center lg:text-left order-2 lg:order-1">
          {/* Attribution */}
          <div ref={secondAttrRef} className="flex flex-col items-center lg:items-end w-full order-1 lg:order-2 mt-4 lg:mt-auto">
            <img
              src={markImg}
              alt="signature mark"
          ...
          {/* Quote */}
          <blockquote ref={secondQuoteRef} className="font-myriad w-full order-2 lg:order-1 mt-3 lg:mt-0 max-w-xl mx-auto lg:mx-0">
            <p className="text-base sm:text-lg lg:text-2xl text-gray-700 font-bold leading-relaxed mb-1 whitespace-normal">
              "We do everything with care, because <br /> homes mean the world
              to people. Great design
            </p>
